...
"#,
    ...
    #[test]
    fn render_derive_parser_empty_about() {
        // Setup
        let parser = DeriveParser {
            struct_name: ident("my_struct"),
            program: DeriveValue {
...
"#,
    ...
    #[test]
    fn render_derive_sub_parser_empty_about() {
        // Setup
        let sub_parser = DeriveSubParser {
            struct_name: ident("my_struct"),
            about: Some(DeriveValue {
...
"#,
    ...
    #[test]
    fn render_derive_sub_parser_about() {
        // Setup
        let sub_parser = DeriveSubParser {
            struct_name: ident("my_struct"),
            about: Some(DeriveValue {
